...
$sql = "SELECT EMP_ID,EMP_MNG_DISCRIM,DEP_ID FROM employees JOIN (SELECT POS_ID,DEP_ID FROM positions) AS TABLE1 ON employees.POS_ID=TABLE1.POS_ID WHERE EMP_EMAIL='$email' AND EMP_PASSWORD='$password' AND EMP_MNG_DISCRIM='0';";
